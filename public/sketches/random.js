  ...
  $.fn.randomizeText = function (options) {
    ...
    singleRandomText = function (v, settings) {
      ...
      randomLetter = function (l, settings) {
        ...
        var i = parseInt(Math.random() * this.settings.randomLetters.length);
        console.log(i);
        setTimeout(function () {
          generateRandomLetter(letter, i);
        }, settings.randomTime);

      }

      generateRandomLetter = function (letter, i) {
        var diff = letter.settings.randomLetters.length - i;
        //console.log(diff);
        letter.currentLetter = letter.settings.randomLetters[i-1];
